...
# setting SOPC_SYSID_BASE_ADDRESS is 0x1010b0
SOPC_SYSID_FLAG += --sidp=0x1010b0
ELF_PATCH_FLAG  += --sidp 0x1010b0

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1518418665
SOPC_SYSID_FLAG += --timestamp=1518418665
ELF_PATCH_FLAG  += --timestamp 1518418665
